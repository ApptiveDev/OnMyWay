  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[560px] mx-auto px-[24px] pt-[40px] pb-[60px]">
        <div className="text-[19px] font-bold text-[#3E2722] mb-[28px] text-center" style={{ fontFamily: "MaruBuriOTF" }}>설정</div>

        <div className="text-[15px] font-bold text-[#3E2722] mb-[16px]" style={{ fontFamily: "Pretendard-Bold" }}>계정</div>
        <div className="flex items-center gap-[10px] flex-wrap mb-[28px]">
          <div className="flex-1 min-w-[200px] h-[46px] rounded-[13px] bg-[#F4EEE3] flex items-center px-[16px] text-[14px] text-[#6a5d52]" style={{ fontFamily: "Pretendard-Medium" }}>
            abcd123@gmail.com
          </div>
          <button
            onClick={notReady}
            className="h-[46px] px-[18px] rounded-[13px] bg-[#F4EEE3] flex items-center justify-center text-[13.5px] text-[#3E2722] cursor-pointer whitespace-nowrap hover:bg-[#EDE3D0]"
        ...
        <div className="text-[15px] font-bold text-[#3E2722] mb-[16px]" style={{ fontFamily: "Pretendard-Bold" }}>프로필</div>
        <div className="flex items-start justify-between gap-[24px] flex-wrap">
          <div className="flex-1 min-w-[160px] h-[46px] rounded-[13px] bg-[#F4EEE3] flex items-center px-[16px] text-[14px] text-[#6a5d52]" style={{ fontFamily: "Pretendard-Medium" }}>
            닉네임
          </div>
          <div className="flex flex-col items-center gap-[10px] shrink-0">
            ...
            <button
              onClick={notReady}
              className="h-[36px] px-[15px] rounded-[10px] bg-[#F4EEE3] flex items-center justify-center text-[12.5px] text-[#3E2722] cursor-pointer hover:bg-[#EDE3D0]"
              style={{ fontFamily: "Pretendard-SemiBold" }}
            >
              프로필 편집
            </button>
        ...
        <div className="text-[15px] font-bold text-[#3E2722] mb-[16px]" style={{ fontFamily: "Pretendard-Bold" }}>고객지원</div>
        <button
          onClick={notReady}
          className="flex items-center justify-between h-[46px] w-full cursor-pointer hover:opacity-75"
        >
          <span className="text-[14px] text-[#3E2722]" style={{ fontFamily: "Pretendard-Medium" }}>문의하기</span>
        ...
        <button
          ...
          className="flex items-center justify-between h-[46px] w-full cursor-pointer hover:opacity-75"
        >
          <span className="text-[14px] text-[#3E2722]" style={{ fontFamily: "Pretendard-Medium" }}>피드백 보내기</span>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M9 6l6 6-6 6" stroke="#c9bcae" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
        </button>
        ...
        <div className="text-right">
          <button
            ...
            className="text-[13.5px] text-[#9a8e84] cursor-pointer hover:text-[#7a6e64]"
            style={{ fontFamily: "Pretendard-SemiBold" }}
          >
            탈퇴하기
          </button>
