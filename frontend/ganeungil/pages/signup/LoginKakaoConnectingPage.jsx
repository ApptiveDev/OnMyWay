...
export default function LoginKakaoConnectingPage() {
  useEffect(() => {
    const timer = setTimeout(() => {
      const redirectUri = `${window.location.origin}/`;
      window.location.href = `/oauth2/authorization/kakao?redirect-uri=${encodeURIComponent(redirectUri)}&flow=login`;
    }, 1500);
